...
export class AnaKategoriEkle extends Component {
  constructor(props) {
  ...
  render() {
    return (
            ...
            <div>
              <h3 style={{textAlign:"center"}}>Ana Kategori Ekle</h3>
             <Form onSubmit={this.handleSubmit} className="mt-3" style={{paddingTop:"10px"}}>
               ...
               <Button variant="success" type="submit" block style={{marginTop:"10px", width:"200px",marginLeft:"10px",marginRight:"10px"}}>Ana Kategori Ekle</Button>
            </Form>
            </div>
...
export default AnaKategoriEkle;
