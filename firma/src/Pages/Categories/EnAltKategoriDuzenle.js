...
export class EnAltKategoriDuzenle extends Component {
  constructor(props) {
  ...
  render() {
    return (
            ...
            <div>
              <h3 style={{textAlign:"center"}}>En Alt Kategori Düzenle</h3>
             <Form onSubmit={this.handleSubmit} className="mt-3" style={{paddingTop:"10px"}}>
               ...
               <Button variant="success" type="submit" block style={{marginTop:"10px", width:"200px",marginLeft:"10px",marginRight:"10px"}}>En Alt Kategori Düzenle</Button>
            </Form>
            </div>
...
export default EnAltKategoriDuzenle;
